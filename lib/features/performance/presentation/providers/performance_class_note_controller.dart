...
part 'performance_class_note_controller.g.dart';

@riverpod
class PerformanceClassNoteController extends _$PerformanceClassNoteController {
  ...
  Future<List<NoteEntity>> _fetch(int page) async {
    final uc = ref.read(getListClassNotesUsecaseProvider);
    final either = await uc.getListClassNotes(
      idStudent: 385,
      page: page,
    );
